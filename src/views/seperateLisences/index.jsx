...
import Constants from "../../api/seperateLisence";
    ...
    <div className="about-page w-full">
      {isFetching ? (
        ...
        <div className="content w-full">
          <p className="page-title">Ana Səhifə Lisenziyalar</p>
          <div className="col-12">
            <Button
              onClick={() => setForm(true)}
              className="b-button p-button-danger"
            >
              Əlavə et
            </Button>
          </div>
          <Dialog
            header={`${
              form?.id ? "Xidmətə düzəliş et" : "Karusel şəkli əlavə et"
            }`}
            visible={form}
            draggable={false}
            onHide={() => setForm(null)}
...
export default SeperateLisences;